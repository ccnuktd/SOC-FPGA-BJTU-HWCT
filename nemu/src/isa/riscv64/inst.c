...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, mul_num = ((signed)src1) * src2; Reg(rd) = BITS(mul_num, 63,32));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, mul_num = ((signed)src1) * ((signed)src2); Reg(rd) = BITS(mul_num, 63,32));
