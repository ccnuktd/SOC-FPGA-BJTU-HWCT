...
wire                                    iresult_mul_vld;
wire [`REG_BUS_WIDTH-1:0]              mul_waddr_o;
pa_core_exu_mul u_pa_core_exu_mul (
    .data1_i                            (reg1_rdata_i),
    .data2_i                            (reg2_rdata_i),
    .clk                                (clk_i),
    .rst_n                              (rst_n_i),
    .waddr_i                            (reg_waddr_i),
    .valid_i                            (op_mul),
...
//     if(((inst_func_i[`INST_FUNC_WIDTH-1:0] & 32'h00_ffffff) == `INST_FUNC_MUL) | iresult_mul_vld)
//         iresult_m_final = {32{subop_high}} & iresult_mul[63:32]
//                         | {32{subop_low }} & iresult_mul[31: 0];
// end
wire [`DATA_BUS_WIDTH-1:0]              iresult_m_final;
assign iresult_m_final = {32{subop_high}} & iresult_mul[63:32]
                     | {32{subop_low }} & iresult_mul[31: 0];
...
assign hold_flag_o = (op_store || op_load)
                  || (op_div || op_rem || div_hold || mul_hold || op_mul);
...
assign reg_waddr_o[`REG_BUS_WIDTH-1:0] = (iresult_div_rem_vld | iresult_mul_vld) ? (iresult_div_rem_vld ? div_reg_waddr[`REG_BUS_WIDTH-1:0]
                                                             : mul_waddr_o[`REG_BUS_WIDTH-1:0])
                                                             : reg_waddr_i[`REG_BUS_WIDTH-1:0];

assign reg_waddr_vld_o                 = (iresult_div_rem_vld | iresult_mul_vld) ? 1'b1
                                                             : reg_waddr_vld_i;

assign iresult_o[`DATA_BUS_WIDTH-1:0] = {32{inst_set_rvi & iresult_i_vld}} & iresult_i_final[`DATA_BUS_WIDTH-1:0]
                                      | {32{iresult_mul_vld}} & iresult_m_final[`DATA_BUS_WIDTH-1:0]
